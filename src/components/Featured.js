...
const FeaturedPost = () => {
  return (
    <section className="p-6 bg-white">
      <h2 className="text-2xl md:text-4xl font-bold font-headingfont text-[#232536] mb-4">Featured Post</h2>
      <div className="flex flex-col  bg-[#F4F4F4] rounded-lg overflow-hidden shadow-md">
        <img src={Building} alt="Featured Post" className="sm:w-full h-64 object-cover" />
        <div className="p-6">
