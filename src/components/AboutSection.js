...
const About = () => {
  return (
    ...
    <section className="p-6 bg-[#F4F4F4] text-[#6D6E76]">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 p-5 md:p-20">
        <div  className='p-1 md:p-10'>
          <h3 className="text-md md:text-xl font-bold font-headingfont text-[#232536] mb-2">ABOUT US</h3>
          <p className='text-lg md:text-3xl font-bold font-headingfont text-black '>We are a community of content writers who share their learnings.</p>
          <p className="mt-2 md:mt-4 font-bodyfont">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
